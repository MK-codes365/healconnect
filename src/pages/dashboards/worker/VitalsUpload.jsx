...
const VitalsUpload = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(`Case submitted for ${patientName} successfully!`);
    ...
    return (
        <div className="vitals-upload-container">
            ...
            <form className="vitals-form" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="submit-btn" disabled={!triageResult || loading}>
                    {loading ? 'Submitting...' : 'Submit to Doctor Queue'}
                </button>
            </form>
        </div>
    );
